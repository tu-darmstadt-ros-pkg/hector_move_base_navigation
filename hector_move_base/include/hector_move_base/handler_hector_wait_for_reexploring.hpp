...
public:
    ...
    bool wait4ReexploreTimeExceeded()
    {
        return hectorMoveBaseInterface->getCurrentGoal().goal_id.stamp + ros::Duration(time_to_trigger_exploration_) < ros::Time::now();
    }
