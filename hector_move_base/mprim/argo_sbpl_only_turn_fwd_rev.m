...
function[] = argo_sbpl_only_turn_fwd_rev(outfilename)
...
if UNICYCLE_MPRIM_16DEGS == 1
    ...
    %1/16 theta change
    basemprimendpts0_c(4,:) = [ 0  0  1 turncostmult];
    basemprimendpts0_c(5,:) = [ 0  0 -1 turncostmult];
    %3/16 theta change
    basemprimendpts0_c(6,:) = [ 0  0  3 fturncostmult];
    basemprimendpts0_c(7,:) = [ 0  0 -3 fturncostmult];
    ...
    %1/16 theta change
    basemprimendpts45_c(4,:) = [ 0  0  1 turncostmult];
    basemprimendpts45_c(5,:) = [ 0  0 -1 turncostmult];    
    %3/16 theta change
    basemprimendpts45_c(6,:) = [ 0  0  3 fturncostmult];
    basemprimendpts45_c(7,:) = [ 0  0 -3 fturncostmult];   
    ...
    %1/16 theta change
    basemprimendpts22p5_c(4,:) = [ 0  0  1 turncostmult];
    basemprimendpts22p5_c(5,:) = [ 0  0 -1 turncostmult];    
    %3/16 theta change
    basemprimendpts22p5_c(6,:) = [ 0  0  3 fturncostmult];
    basemprimendpts22p5_c(7,:) = [ 0  0 -3 fturncostmult];
